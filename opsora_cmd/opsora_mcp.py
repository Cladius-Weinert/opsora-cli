...
class MCPClient:
    ...
    def load_config(self, config_path: str = "") -> None:
        ...
        try:
            # Use builtin open() (not Path.read_text) so config loading is
            # patchable in tests and behaves consistently.
        ...
        if server.transport == "stdio":
            ...
            try:
                ...
                try:
                    ...
                    resp.close()
                # Unwrap JSON-RPC envelope when present ({"result": {...}}),
                # while accepting a bare {"content": [...]} payload too.
